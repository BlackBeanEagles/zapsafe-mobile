  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        _WireRow(label: 'sentry_flutter', value: '^7.16.0', path: 'pubspec.yaml:67'),
        _WireRow(label: 'Boot wrapper', value: 'CrashReporting.init(_bootstrap)', path: 'lib/main.dart:18'),
        _WireRow(label: 'DSN source', value: '--dart-define=SENTRY_DSN', path: 'crash_reporting.dart'),
        ...
        _WireRow(label: 'Environment tag', value: CrashReporting.environment, path: 'CrashReporting.environment'),
        _WireRow(label: 'sendDefaultPii', value: 'false', path: 'crash_reporting.dart'),
        _WireRow(label: 'attachScreenshot', value: 'false (SOS screen may show a live map)', path: 'crash_reporting.dart'),
        _WireRow(label: 'attachViewHierarchy', value: 'false', path: 'crash_reporting.dart'),
        _WireRow(label: 'tracesSampleRate', value: 'release: 0.05 · debug: 0.0', path: 'crash_reporting.dart'),
        _WireRow(label: 'beforeSend', value: '_scrub() allowlist rebuild', path: 'crash_reporting.dart'),
        const SizedBox(height: ZapSpacing.lg),
