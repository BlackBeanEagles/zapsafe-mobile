      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _SectionLabel('STORAGE STRATEGY'),
            SizedBox(height: ZapSpacing.md),
            _StorageStrategyCard(),
            SizedBox(height: ZapSpacing.xl),
            _SectionLabel('TOKEN VAULT DEMO'),
            SizedBox(height: ZapSpacing.md),
            _TokenVaultDemo(),
            SizedBox(height: ZapSpacing.xl),
            _SectionLabel('DIO INTERCEPTOR — AUTO-REFRESH'),
            SizedBox(height: ZapSpacing.md),
            _InterceptorCard(),
            SizedBox(height: ZapSpacing.xl),
            _SectionLabel('SECURITY RULES'),
            SizedBox(height: ZapSpacing.md),
            _SecurityRules(),
