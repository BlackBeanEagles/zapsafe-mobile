...
import '../screens/day364_launch_day_runbook_screen.dart';          // Day 364
...
import '../screens/day383_privacy_audit_followup_screen.dart';      // Day 383
...
import '../screens/day391_message_safety_check_screen.dart';
import '../screens/day392_model_attributions_screen.dart';       // Day 391
...
class AppRoutes {
  ...
  static const modelAttributions         = '/day-392-model-attributions';                   // Day 392
}
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppRoutes.launchDayRunbook,
        builder: (context, state) =>
            const Day364LaunchDayRunbookScreen(),                            // Day 364
      ),
      GoRoute(
        path: AppRoutes.publicLaunchMilestone,
        builder: (context, state) =>
            const Day365PublicLaunchMilestoneScreen(),                       // Day 365
      ),
      GoRoute(
        path: AppRoutes.liveSosDashboard,
        builder: (context, state) =>
            const Day366LiveSosDashboardScreen(),                            // Day 366
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.supportTriage,
        builder: (context, state) =>
            const Day369SupportTriageScreen(),                               // Day 369
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.falsePositiveField,
        builder: (context, state) =>
            const Day373FalsePositiveFieldScreen(),                          // Day 373
      ),
      GoRoute(
        path: AppRoutes.modelFeedbackExport,
        builder: (context, state) =>
            const Day374ModelFeedbackExportScreen(),                         // Day 374
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.privacyAuditFollowup,
        builder: (context, state) =>
            const Day383PrivacyAuditFollowupScreen(),                       // Day 383
      ),
      GoRoute(
        path: AppRoutes.dpdpSignoff,
        builder: (context, state) =>
            const Day384DpdpSignoffScreen(),                                // Day 384
      ),
      GoRoute(
        path: AppRoutes.supportMacrosProduction,
        builder: (context, state) =>
            const Day385SupportMacrosProductionScreen(),                    // Day 385
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.modelAttributions,
        builder: (context, state) =>
            const Day392ModelAttributionsScreen(),                          // Day 392
      ),
      GoRoute(
